...
const Home = () => {
  ...
  return (
    <div className="flex justify-center bg-gray-800 min-h-screen py-8 px-4">
      {/* Main container with refined shadow and border */}
      <div className="w-[70%] bg-gray-800 flex flex-col rounded-xl shadow-lg overflow-hidden h-[90vh]">
        <Header />
